...
export default function HomeworkAssignmentBuilderPage({
  ...
  const [isPublishReadinessOpen, setIsPublishReadinessOpen] = useState(false);
  ...
  const isReadyToPublish =
    !isDirty && !hasQuestionValidationErrors && publishReadiness.isReady;
            ...
            {lifecycle?.isEditable && (
              <>
                <Button
                  ...
                  className="h-9 w-9 cursor-pointer px-2"
