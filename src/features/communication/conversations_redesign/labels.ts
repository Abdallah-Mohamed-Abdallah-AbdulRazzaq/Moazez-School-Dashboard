...
export const conversationRedesignLabels = {
  en: {
    ...
    moderationReasonRequired: "Enter a reason for this action.",
    moderationActionTitle: "Moderate message",
    confirmModerationAction: "Confirm action",
    moderationActionComplete: "Moderation action completed.",
    unableToModerateMessage: "Unable to moderate this message.",
    editOtherMessageConfirm:
      "This changes the original author's message. Continue?",
    ...
    errorAttachmentSizeLimit: "Attachment must be {size} MB or smaller.",
  ...
  ar: {
    ...
    pendingJoinRequests: "طلبات انضمام معلقة",
    ...
    moderationReasonRequired: "أدخل سبباً لهذا الإجراء.",
    moderationActionTitle: "إدارة الرسالة",
    confirmModerationAction: "تأكيد الإجراء",
    moderationActionComplete: "تم تنفيذ إجراء الإشراف.",
    unableToModerateMessage: "تعذر تنفيذ إجراء الإشراف على الرسالة.",
    editOtherMessageConfirm: "سيؤدي هذا إلى تغيير رسالة الكاتب الأصلي. متابعة؟",
    ...
    errorAttachmentSizeLimit: "يجب ألا يزيد حجم المرفق عن {size} ميجابايت.",
